...
public class HyperionFabric1182 implements ModInitializer, ClientModInitializer {
    ...
    public void onInitialize() {
        ...
        System.out.println("[Hyperion] Initialized Hyperion Multi-Core Engine on Fabric 1.18.2");
    }
    ...
    public void onInitializeClient() {
        HyperionConfig config = HyperionConfigStorage.loadOrCreate();
        HyperionEngine.getInstance().initialize(config);
        System.out.println("[Hyperion] Initialized Hyperion Client & Keybindings on Fabric 1.18.2");
    }
}
