...
public class HyperionFabric1182 implements ModInitializer {
    @Override
    public void onInitialize() {
        HyperionConfig config = new HyperionConfig();
        HyperionEngine.getInstance().initialize(config);
        System.out.println("[Hyperion] Initialized Hyperion Multi-Core Engine on Fabric 1.18 / 1.18.1 / 1.18.2");
    }
}
